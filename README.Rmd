...
<div style="text-align: center; background-color: #f5f5f5; padding: 20px; border-radius: 8px; border: 1px solid #ddd; margin: 20px auto; max-width: 500px;">
  <h2 style="color: #2C3E50; margin-bottom: 10px;">Shiny App Available</h2>
  <p>
...
4. Prints a confirmation message, for example:
When you call the function calc_cons_emissions(data), it will print:
...
**Jianing Ding**<br>
[jianing.research@gmail.com](mailto:jianing.research@gmail.com)<br>
Tongji University<br><br>

**Ka Leung Lam**<br>
[kaleung.lam@dukekunshan.edu.cn](mailto:kaleung.lam@dukekunshan.edu.cn)<br>
Duke Kunshan University<br><br>

**Nathaniel Geiger**<br>
[geigern@umich.edu](mailto:geigern@umich.edu)<br>
...
**Ziqian Xia**<br>
[ziqianx@stanford.edu](mailto:ziqianx@stanford.edu)<br>
Stanford University<br><br>

**Jinliang Xie**<br>
[jinliang.research@gmail.com](mailto:jinliang.research@gmail.com)<br>
Tsinghua University
